...
Original file is located at
    https://colab.research.google.com/drive/1Q7TTSMmBjkClOwLH0whTkiQfxRt1kRG-
"""
...
async def start_command(message: types.Message):
    await message.answer("Здравствуйте! Меня зовут Нежа. Как я могу Вам помочь?", reply_markup=keyboard)
...
async def about_bot(message: types.Message):
    await message.answer("Пожалуйста, пришлите фотографию, фиксирующий Вашу проблему")
